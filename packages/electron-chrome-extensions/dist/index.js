...
/*!**********************************************************!*\
  !*** D:/projects/browser/node_modules/has-flag/index.js ***!
  \**********************************************************/
...
/*!****************************************************************!*\
  !*** D:/projects/browser/node_modules/supports-color/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! ./common */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/common.js")(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(/*! ms */ "./node_modules/.store/ms@2.1.2/node_modules/ms/index.js");
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __webpack_require__(/*! ./browser.js */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/browser.js");
} else {
	module.exports = __webpack_require__(/*! ./node.js */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/node.js");
}
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:browserAction');
          ...
          case 'extension-icon':
            {
              ...
              if (extension && iconDetails) {
                if (typeof iconDetails.path === 'string') {
                  ...
                  let iconAbsPath = imagePath && Object(_common__WEBPACK_IMPORTED_MODULE_2__["resolveExtensionPath"])(extension, imagePath);
                  iconAbsPath = (_iconAbsPath = iconAbsPath) === null || _iconAbsPath === void 0 ? void 0 : _iconAbsPath.replace('/chrome-extension:/' + extensionId, ''); // 修复油猴的图标出不来的问题
                  if (iconAbsPath) iconImage = electron__WEBPACK_IMPORTED_MODULE_0__["nativeImage"].createFromPath(iconAbsPath);
...
/*!*********************************!*\
  !*** ./src/browser/api/i18n.ts ***!
  \*********************************/
/*! exports provided: I18nAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I18nAPI", function() { return I18nAPI; });
...
class I18nAPI {
  ...
  getAllMessage(event) {
    let manifest = Object(_common__WEBPACK_IMPORTED_MODULE_0__["getExtensionManifest"])(event.extension);
    let localeName = electron__WEBPACK_IMPORTED_MODULE_1__["app"].getLocale().replace('-', '_');
    let localePath = Object(_common__WEBPACK_IMPORTED_MODULE_0__["resolveExtensionPath"])(event.extension, '_locales');
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:tabs');
class TabsAPI {
  constructor(ctx) {
    this.ctx = ctx;
    const handle = this.ctx.router.apiHandler();
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:webNavigation');
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:windows');
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:popup');
class PopupView {
...
const createDebug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js");
...
const debug = __webpack_require__(/*! debug */ "./node_modules/.store/debug@4.3.4/node_modules/debug/src/index.js")('electron-chrome-extensions:store');
