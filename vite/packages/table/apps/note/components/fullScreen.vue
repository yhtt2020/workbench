<template>
  <teleport to="body">
    ...
    <div class="pop-box flex flex-col flex-wrap justify-center">
      <!-- 顶部 -->
      <div style="justify-content: space-between;background-color: var(--secondary-bg);height: 64px;"
           class="flex w-full items-center px-3">
      ...
      <!-- 主体 -->
      <div class="flex flex-1 h-0" style="width:950px;margin-top: 20px;">
        <div class="shadow overflow-hidden flex-col flex h-full" style="border-radius: 12px;padding: 24px 0 0 0 ;"
          ...
          ></a-input>
          <div class="mt-4 scroll-color xt-scroll flex-1 h-0"  >
