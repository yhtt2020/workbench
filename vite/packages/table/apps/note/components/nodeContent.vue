            ...
            <div style="justify-content: space-between;" class="flex w-full" >
                ...
                <div class="flex" style="position: relative;">
                    ...
                    <a-dropdown :trigger="['click']">
                            <div class="flex items-center pointer justify-center" style="width: 40px;height:40px;background: var(--secondary-bg);border-radius: 10px;">
...
import { message } from 'ant-design-vue';
 export default {
   ...
   computed: {
        ...
        background(){
            if (this.noteList.length) {
                if(this.selNote>=0?this.noteList[this.selNote].customData){
