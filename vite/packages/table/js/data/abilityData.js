...
export const powerList = [
    {icon:'image',name:'锁屏壁纸',detail:{
      1:'静态壁纸',2:'静态壁纸',3:'动态壁纸',4:'动态壁纸',5:'动态壁纸',10:'动态壁纸'}
    },
    {icon:'smile',name:'弹幕',detail: {
      1:'发弹幕',2:'发弹幕',3:'发弹幕',4:'发弹幕',5:'关闭弹幕',10:'关闭弹幕'}
    },
    {icon:'thunderbolt',name:'快捷指令',detail: {
      1:'5组',2:'5组',3:'自定义指令',4:'自定义指令',5:'10组',10:'10组'}
    },
    {icon:'team',name:'团队',detail: {
      1:'仅加入',2:'创建团队',3:'创建团队',4:'创建团队',5:'创建团队',10:'创建团队'}
    },
    {icon:'linechart',name:'数据监控助手',detail: {
