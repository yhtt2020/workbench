  ...
  <a-drawer title="设置" :placement="right"  v-model:visible="captureNewShow" width="500">
    <div class="flex flex-col">
      ...
      <div class="flex items-center  mb-6">
        ...
        <span class="mr-3 drawer-item-bg rounded-lg replace-key pointer">更换按键</span>
        <span class="mr-3 rounded-lg drawer-item-bg replace-key pointer">重置</span>
      </div>
      ...
      <div class="flex items-center mb-6">
        ...
        <span class="mr-3 rounded-lg drawer-item-bg replace-key pointer">更换按键</span>
        <span class="mr-3 rounded-lg drawer-item-bg replace-key pointer">重置</span>
      </div>
    </div>
