    ...
    <div @click="enterWeather" v-else>
      ...
      <a-row>
        <a-col :span="7" style="text-align: center">
          <i style="font-size: 4em" :class="'qi-'+city.weather.now.icon+'-fill'"></i>
        </a-col>
        <a-col :span="17" style="text-align: center">
          <div style="font-size: 1.5em;font-weight: bold;padding-top: 1em">{{ today.month }}月{{ today.day }}日 {{ today.week }}</div>
      ...
      <a-row style="margin-top:1em">
        <a-col :span="12" style="text-align: center">
          ...
          <div style="font-size: 1.2em">
            <i style="font-size: 1.2em" :class="'qi-'+city.d7.daily[1].iconDay+'-fill'"></i>
        ...
        <a-col :span="12" style="text-align: center">
          ...
          <div style="font-size: 1.2em">
            <i style="font-size: 1.2em" :class="'qi-'+city.d7.daily[2].iconDay+'-fill'"></i>
...
export default {
  ...
  methods: {
    ...
    add () {
      this.$router.push({ name: 'weather' ,params:{
        add:'1'
        }})
    }
  }
