    ...
    <a-col :xxl="6" :xl="8" :lg="12" v-for="team in list">
      <div class="m-3 s-bg rounded-xl p-1 pointer"  @click="onAction(team)">
        <a-row :gutter="10">
          ...
          <a-col>
            <div class="mt-5">
              ...
              <div class="inline-block relative" style="width: 20px;vertical-align: middle;">
        ...
        <div class="m-5 ml-6 mt-1 mb-3">
          <a-row :gutter="40">
            <a-col :span="4">
              <a-avatar v-if="team.leaderInfo" style="border: 1px solid rgba(255,255,255,0.73)" :src="team.leaderInfo.data.userInfo.avatar"></a-avatar>
            </a-col>
