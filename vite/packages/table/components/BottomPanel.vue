<template>
  <div class="bottom-panel flex flex-row items-center justify-center w-full" style="text-align: center" @contextmenu.stop="showMenu">
    <div class="common-panel user suspension-background" style="display: inline-block;vertical-align: top">
      <div v-if="!userInfo">
...
<!--    </div>-->
    <div class=" flex flex-row  items-center pl-6 suspension-background" style="border-radius: 8px; height: 73px;overflow: hidden;margin-right: 10px">
        ...
        <div class="pointer mr-3 mr-6" style="white-space: nowrap;display: inline-block" v-for="item in navigationList" @click="clickNavigation(item)" v-else>
              <div style="width: 56px;height:56px;" v-if="item.type==='systemApp'" class="suspension-item flex justify-center items-center rounded-xl">
