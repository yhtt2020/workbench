  ...
  <div class="flex items-center justify-between mb-3">
    <div class="flex">
      ...
      <div class="flex flex-col ml-3">
        ...
        <div class="flex ">
          <div v-if="orderData.store==='jd'" class="flex items-center rounded-md xt-active-text justify-center w-6 h-6 "
        ...
        <div class="flex items-center">
          ...
          <div v-if="orderData.content.parentOrderId"
               class="xt-bg-2 w-6 h-6 rounded-md flex items-center justify-center">拆
          </div>
        </div>
      </div>
    </div>
