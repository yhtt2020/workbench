      ...
      <vue-custom-scrollbar :settings="settingsScroller">
        ...
        <div class="flex-grow flex w-full justify-between px-5">
          <div class="w-1/2 flex flex-col">
            ...
            <div class="flex items-center rounded-xl justify-center h-10 px-3 mb-6"
                 style="border: 1px solid var(--divider);">
              <a-input v-model:value="randomNickname" placeholder="请输入" :bordered="false"
          ...
          <div class="w-1/2 flex flex-col">
            ...
            <a-textarea v-model:value="areaValue" placeholder="请输入" class="rounded-lg no-scrollbar mb-6" :rows="3"
                        :maxlength="200" style="height: 100px;"/>
        ...
        <div class="flex w-full items-center justify-center mt-6">
          ...
          <a-button type="primary" class="h-48 rounded-xl" style="width:120px;color: var(--active-text);"
                    @click="comSave">
            保存
          </a-button>
        </div>
