<template>
  <div class="flex flex-row items-center justify-center w-full h-full">
    <div @click.stop="()=>{}" class="w-1/2  h-82 max-w-lg rounded-xl flex flex-col  pt-6  mr-10 p-10 px-15"
      ...
      <div>
        ...
        <div class="mb-5"><strong class="text-white">注意：团队号为有限资源，一旦选定，终身有效，除非解散小队，</strong></div>
        <a-row :gutter="10">
          <a-col :span="4">
          ...
          <a-col :span="20">
            <div class="rounded-xl h-10 w-100 flex justify-center items-center mt-4 pointer text-white"
