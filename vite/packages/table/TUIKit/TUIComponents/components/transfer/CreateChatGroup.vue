 ...
 <div class="flex flex-col mb-3" style="padding: 12px; width: 650px; height: 530px;">
  ...
  <div class="flex items-center flex-col justify-center">
   ...
   <div class="rounded-lg flex pointer items-center justify-center" style="width: 64px;height: 64px; position:relative"  @click="onShowSelect">
    ...
    <CreateIcon icon="akar-icons:cloud-upload" width="20" height="20" style="font-size: 1.5rem;width:24px;height:24px;position: absolute;bottom:-3px;right:-3px;border: 2px solid var(--primary-text);background:var(--active-bg);border-radius: 50%;" color="var(--secondary-text)"/>
   </div>
