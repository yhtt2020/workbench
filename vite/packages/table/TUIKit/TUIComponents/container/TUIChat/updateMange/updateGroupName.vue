<template>
 <div class="flex items-center flex-col" style="color: var(--primary-text);">
  ...
  <a-input v-model:value="groupRef" :disabled="groupInfo.role !== 'Owner'" style="color: var(--primary-text);border-radius: 12px !important;"></a-input>
  <a-button type="primary" v-if="groupInfo.role === 'Owner'" @click="saveGroupName" style="width: 100%; height: 48px; margin-top: 24px;border-radius: 12px !important;">保存</a-button> 
