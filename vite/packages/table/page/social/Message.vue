<template>
  <div class="ml-4">
    <a-row class="card flex auto-height s-bg " style="width:100%;max-width:50em;padding: 1em; background-color: var(--nop-active-background-color);color: var(--primary-text)" :gutter="20">
      <a-col :span="24">
