...
<!--  </div>-->
  <GameListDrawer :activeId="currentDeskId" :items="recentGameList.slice(3)" @visibleChanged=""
...
export default {
  ...
  computed: {
    ...mapWritableState(steamUserStore, ['desks', 'runningGame', 'recentGameList','deskList']),
