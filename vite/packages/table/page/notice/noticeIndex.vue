<template>
  <div class="flex h-full">
    <div class="flex flex-col items-center">
      <div v-for="(item,index) in notice.session" 
        class="flex pointer items-center rounded-lg flex-col mb-2 justify-center" 
        style="width: 56px;height: 56px;"  :class="{'active-bg':selectIndex === index}"  
    ...
    <div class="flex flex-col" style="width: 395px;">
      ...
      <template v-if="notice.message[selectIndex] !== undefined">
        <div class="flex items-center justify-center" v-if="notice.message[selectIndex].noticeList.length === 0">
          ...
          <div class="flex justify-between mb-4" v-if="selectIndex === 0">
            <div class="flex items-center ">
              <div class="flex items-center justify-center"  style="width: 32px;height: 32px;">
                <img :src="notice.message[0].noticeIcon" class="w-full h-full"  alt="">
              </div>
...
export default {
  ...
  computed:{
    ...mapWritableState(noticeStore,['notice','noticeEnable']),
  },
  data(){
    return{
      selectIndex:'',
