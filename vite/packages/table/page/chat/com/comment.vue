    ...
    <div class="w-full">
        <div class="flex mt-4 mb-4 ">
            ...
            <div class="flex items-center">
                <a-button type="text" class="mr-3 reply w-[57px] h-[32px] xt-bg " @click="clickLike"
                    :class="{ 'xt-theme-text': isLike }" style="position: relative;">{{ like }}</a-button>
        ...
        <div class="flex justify-between mt-2 mb-4 font-14 input-btm">
            ...
            <a-button type="primary" class="reply xt-text" style="color: var(--secondary-text) !important; ">回复</a-button>
        </div>
        <div class="mb-4 font-14 xt-text" >
            评论 {{ comment }}
        </div>
        <MainReplyComment></MainReplyComment>
    </div>
</template>
