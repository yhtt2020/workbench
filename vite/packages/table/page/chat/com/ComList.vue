        ...
        <div class="card-content">
            ...
            <div>
                <div class="flex items-center justify-center ">
                    <img :src="cardData.data.img" alt="" class="object-cover w-1/4 h-full mr-5" v-if="cardData.data?.img.length===1">
                ...
                <template v-if="cardData.data?.img.length>1">
                        <div class="flex w-full p-0 mt-2 mb-2 whitespace-pre-wrap cover-wrapper" >
                          <img :src="item" alt="" v-for="(item,index) in cardData.data?.img"   class="object-cover mr-2 rounded-md cover-sm" :key="index">
                        </div>
                </template>
