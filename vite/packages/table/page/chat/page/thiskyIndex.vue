<template>
  <a-row class="w-full h-full">
    <a-col flex=" 0 1 300px" class="find-left h-full flex flex-col px-3" v-if="isFloat === false"
          ...
          <ChatFold :title="item.name">
            <div class="flex flex-col" v-if="doubleCol === false">
              ...
              >
                ...
                <SelectOutlined  class="ml-1 xt-text-2 flip" style="font-size: 14px" v-if="item.props.openMethod==='userSelect'" />
              </div>
            </div>
