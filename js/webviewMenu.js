...
const webviewMenu = {
  ...
  showMenu: function (data, extraData) { // data comes from a context-menu event
    ...
    //   label: 'Send Feedback',
    //   click: function () {
    //     browserUI.addTab(tabs.card({ url: 'https://github.com/minbrowser/min/issues/new?title=Translation%20feedback%20for%20' + encodeURIComponent(tabs.get(tabs.getSelected()).url) }), { enterEditMode: false, openInBackground: false })
    //   }
    // })
